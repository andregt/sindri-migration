...
class DatabaseCreator {
    ...
    _createColumn(columnName, columnInfo, tableInfo, table) {
        ...
        else if (columnInfo.typeSize) {

            newColumn = tableInfo.specificType(columnName, `${columnInfo.type} (${columnInfo.typeSize})`);
        ...
        ////////////////////////////////////////////////////////////////
            ...
            newColumn = table.specificType(columnName, columnInfo.type);
